const langs = {
  ...
  HK: {
    ...
    currency: ['HKD'],
    languages: ['zh', 'zh(Traditional)', 'en'],
  },
  HM: {
  ...
  MO: {
    ...
    capital: '',
    currency: ['MOP'],
    languages: ['zh', 'zh(Traditional)', 'pt'],
  },
  MP: {
  ...
  SG: {
    ...
    capital: 'Singapore',
    currency: ['SGD'],
    languages: ['en', 'ms', 'ta', 'zh(Simplified)', 'zh'],
  },
  SH: {
    name: 'Saint Helena',
    native: 'Saint Helena',
...
async function handleRequest(request) {
  ...
  const allowedDomains = ['allmy.work', 'rmsuthar.github.io'];

  // Get the "Origin" header from the incoming request
  const requestOrigin = request.headers.get('Origin');

  // Check if the request origin is allowed
  if (requestOrigin && allowedDomains.includes(getDomain(requestOrigin))) {
    // If the request origin is allowed, add the "Access-Control-Allow-Origin" header to the response
  ...
  cf = {
    ...cf,
    countryName: langs[cf.country].name,
    native: langs[cf.country].native,
    isChina: langs[cf.country].languages.indexOf('zh') >= 0,
    isEU: cf.continent == 'EU',
    lang: langs[cf.country].languages,
  }
